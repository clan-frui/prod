...
(function (factory) {
    ...
    $h = {
        ...
        DEFAULT_PREVIEW: '<div class="file-preview-other"  style="width: 30px;height: 30px;">\n' +
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tMain1 = '{preview}\n' +
                ...
                '</div>';
            tMain2 = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n';
            tPreview = '<div class="file-preview {class}" style="width: 410px;">\n' +
                '    {close}' +
                '    <div class="{dropClass}">\n' +
            ...
            tFileIcon = '<i class="glyphicon glyphicon-file kv-caption-icon" style="font-size: 14px;"></i>';
            tCaption = '<div tabindex="500" class="form-control file-caption {class}" style="width: 217px;">\n' +
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                '    <div class="file-footer-caption" title="{caption}" style="margin-top: 15px;">{caption}</div>\n' +
            ...
            tTagBef1 = tTagBef + '><div class="kv-file-content" style="width: 30px;height: 30px;">\n';
            tTagBef2 = tTagBef + ' title="{caption}"><div class="kv-file-content" style="width: 30px;height: 30px;">\n';
            tTagAft = '</div>{footer}\n</div>\n';
            tGeneric = '{content}\n';
            tHtml = '<div class="kv-preview-data file-preview-html" title="{caption}" ' + $h.STYLE_SETTING +
                '>{data}</div>\n';
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data" style="width: 50px;height: 50px;" title="{caption}" alt="{caption}" ' +
                $h.STYLE_SETTING + '>\n';
    ...
    $.fn.fileinput.defaults = {
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="glyphicon glyphicon-file" style="font-size: 30px; position: absolute; margin-top: 15px;"></i>',
