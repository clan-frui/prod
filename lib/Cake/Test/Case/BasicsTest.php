 ...
 */
	public function testEnv() {
		...
		$_SERVER['SCRIPT_NAME'] = '/a/test/test.ctp';
		$this->assertEquals(env('SCRIPT_NAME'), '/a/test/test.ctp');

		$_SERVER = $_ENV = array();

		$_ENV['CGI_MODE'] = 'BINARY';
		$_ENV['SCRIPT_URL'] = '/a/test/test.ctp';
		$this->assertEquals(env('SCRIPT_NAME'), '/a/test/test.ctp');
		...
		$_ENV['SCRIPT_URI'] = 'https://domain.test/a/test.ctp';
		$this->assertTrue(env('HTTPS'));

		$_ENV['SCRIPT_URI'] = 'http://domain.test/a/test.ctp';
		$this->assertFalse(env('HTTPS'));
