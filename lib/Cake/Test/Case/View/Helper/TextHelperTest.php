 ...
 */
	public static function autoLinkProvider() {
		return array(
			...
			array(
				'This is a test that includes http://example.com/test.ctp?foo=bar text',
				'This is a test that includes <a href="http://example.com/test.ctp?foo=bar">http://example.com/test.ctp?foo=bar</a> text',
			),
			array(
				'This is a test that includes www.example.com/test.ctp?foo=bar text',
				'This is a test that includes <a href="http://www.example.com/test.ctp?foo=bar">www.example.com/test.ctp?foo=bar</a> text',
			),
			array(
