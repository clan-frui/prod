 ...
 */
	public function testGet() {
		...
		$this->RequestSocket->expects($this->at(5))
			->method('request')
			->with(array('method' => 'GET', 'uri' => 'https://secure.example.com/test.ctp?one=two'));
		...
		$this->RequestSocket->get('https://secure.example.com/test.ctp', array('one' => 'two'));
 ...
 */
	public function testHead() {
		...
		$this->RequestSocket->expects($this->at(5))
			->method('request')
			->with(array('method' => 'HEAD', 'uri' => 'https://secure.example.com/test.ctp?one=two'));
		...
		$this->RequestSocket->head('https://secure.example.com/test.ctp', array('one' => 'two'));
